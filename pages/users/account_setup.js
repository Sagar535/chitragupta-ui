...
import { accountSetup } from "../../redux/actions/authActions";
...
const AccountSetup = ({accountSetup}) => {
  ...
  const { account_setup_token } = router.query;
  ...
  const handleSubmit = async (e) => {
    ...
    accountSetup(account_setup_token, password, passwordConfirmation)
  };
